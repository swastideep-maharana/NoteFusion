...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden">
      {/* Background Animation Effects - Increased opacity and adjusted z-index */}
      <div className="absolute inset-0 z-0">
        <motion.div
          ...
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-gradient-to-br from-blue-500 to-purple-500 rounded-full blur-2xl opacity-30"
        />
        <motion.div
          animate={{
            scale: [1, 1.1, 1],
          ...
          className="absolute top-1/2 right-1/4 -translate-y-1/2 w-[400px] h-[400px] bg-gradient-to-br from-pink-500 to-orange-500 rounded-full blur-2xl opacity-30"
        />
        <motion.div
          animate={{
            scale: [1, 1.3, 1],
          ...
          className="absolute bottom-1/4 left-1/4 w-[600px] h-[600px] bg-gradient-to-br from-cyan-500 to-teal-500 rounded-full blur-2xl opacity-30"
        />
      </div>

      {/* Form Container - Adjusted backdrop-blur */}
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-medium hover:from-cyan-600 hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-zinc-900 transition-all disabled:opacity-50"
            >
      ...
      {/* Adjusted Background Gradient - Reduced opacity */}
